...
import { garantia, fechamento, agencia, linkTexto } from "@/content/agencia";
      ...
      <Secao id="garantia" tom="claro" className="py-28 sm:py-36">
        <div className="grid gap-14 lg:grid-cols-[1fr_26rem] lg:gap-20">
          ...
          <div className="lg:pt-2">
            ...
            <Revelar atraso={0.34}>
              <Botao
                href={linkTexto(garantia.mensagemTexto)}
                variante="escuro"
                tamanho="lg"
                externo
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Revelar atraso={0.18}>
            <div className="mt-11 flex justify-center">
              <Botao href={linkTexto(fechamento.mensagemTexto)} variante="claro" tamanho="lg" externo>
