...
import { hero, linkTexto, agencia } from "@/content/agencia";
        ...
        <div>
          <Revelar>
            <p className="flex items-center gap-3">
              <span className="relative flex h-1.5 w-1.5">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-vivo opacity-60" />
                <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-vivo" />
              </span>
          ...
          <Revelar atraso={0.36}>
            <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Botao href={linkTexto(hero.mensagemTexto)} variante="claro" tamanho="lg" externo>
