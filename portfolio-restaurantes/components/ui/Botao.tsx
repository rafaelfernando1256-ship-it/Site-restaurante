...
/* ═══════════════════════════════════════════════════════════════
   BOTÃO
   Decisão de direção de arte: a ação principal é OSSO (claro). Num
   conjunto quase monocromático, cor saturada grita e derruba a
   percepção de valor. O acento de cobre fica reservado ao plano em
   destaque, onde precisa mesmo puxar o olho.
   ═══════════════════════════════════════════════════════════════ */
type Variante = "claro" | "contorno" | "acento" | "escuro";
...
const variantes: Record<Variante, string> = {
  ...
  acento:
    "bg-cobre text-[#1b1206] shadow-[0_1px_0_rgba(255,255,255,0.28)_inset] " +
    "hover:-translate-y-0.5 hover:bg-[#d08a45] hover:shadow-[0_10px_28px_-6px_rgba(184,115,51,0.4)]",
};
